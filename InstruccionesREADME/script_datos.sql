...
(next value for secuencia_familia,'bater�as',1),
...
values
(next value for secuencia_producto,11590,'Lubricante Sintetico 5W-30 1lt','el Lubricante Sintetico 5W-30 1lt es lo mejor que encontrar� en el mercado de lubricantes',4,1,10),
(next value for secuencia_producto,35000,'Bater�a 55 A Derecho Positivo 315 CCA','La Bater�a Autobatt es una pieza clave para todo veh�culo, ya que al alimentar el motor de partida',3,3,8),
(next value for secuencia_producto,5900,'Coolant anticorrosivo 1 gl bid�n','El Coolant anticorrosivo Autostyleforma parte de los accesorios autom�viles que previenen da�os en los motores',7,3,9)
